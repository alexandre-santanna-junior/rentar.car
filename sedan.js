function calcular(){
    ...
    const sedan = (80 * d) + (0.30 * k);
    document.querySelector('.resposta').innerHTML = `O valor do aluguel no periodo de ${d} dias e a distância de ${k} Km. </br> Será de: R$ ${sedan} reais. `;
